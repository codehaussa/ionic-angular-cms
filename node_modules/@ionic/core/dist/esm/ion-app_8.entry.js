...
import { c as createKeyboardController } from './keyboard-controller-73b4e12e.js';
...
import { t as transition } from './index-44215e8e.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('inputShims', needInputShims())) {
          ...
          import('./input-shims-c7404a50.js').then((module) => module.startInputShims(config, platform));
        }
