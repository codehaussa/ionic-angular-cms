...
const index = require('./index-f0d7c9cc.js');
...
const getResizeContainer = (resizeMode) => {
   ...
   */
  if (index.doc === undefined || resizeMode === exports.KeyboardResize.None || resizeMode === undefined) {
    return null;
  }
  /**
   ...
   */
  const ionApp = index.doc.querySelector('ion-app');
  return ionApp !== null && ionApp !== void 0 ? ionApp : index.doc.body;
};
/**
