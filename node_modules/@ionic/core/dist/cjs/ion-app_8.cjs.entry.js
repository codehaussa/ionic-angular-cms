...
const index$2 = require('./index-e08e2160.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-347e8a6f.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
