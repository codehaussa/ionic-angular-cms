...
const index = require('./index-dc56ac38.js');
const helpers = require('./helpers-77560954.js');
const keyboardController = require('./keyboard-controller-91b004e1.js');
...
const enableScrollAssist = (componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, keyboardResize, disableClonedInput = false) => {
   ...
   */
  const addScrollPadding = enableScrollPadding && (keyboardResize === undefined || keyboardResize.mode === keyboardController.KeyboardResize.None);
  /**
...
const startInputShims = async (config, platform) => {
   ...
   */
  const keyboardResizeMode = await keyboardController.Keyboard.getResizeMode();
